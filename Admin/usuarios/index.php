            ...
            var dataTable = $('#datos_usuario').DataTable({
                 'rowCallback': function (row, data, index) {
                   ...
                   if (data[3]== 'on-line') {
                        ...
                        $(row).find('td:eq(3)').css({ "color": "green", "font-weight": "bold", "text-align": "center" });
                    }
                    //if (data[4] == 'Reparado') {
                     //   $(row).find('td:eq(4)').css({ "color": "blue", "font-weight": "bold", "text-align": "center" });
                    //}
                    //if (data[4] == 'Revisión') {
                    //    $(row).find('td:eq(4)').css({ "color": "orange", "font-weight": "bold", "text-align": "center" });
                    //}
                    if (data[3] == 'off-line') {
                        $(row).find('td:eq(3)').css({ "color": "red", "font-weight": "bold", "text-align": "center" });
                    }
